...
export const SCREENS: Record<JobId, Record<string, ComputerBeat>> = {
  "standardize-room": {
    ...
    m3: {
      ...
      host: "figma.com",
      path: "/file/acme-workflow-review",
      title: "Acme workflow review",
      site: "figma",
      tabs: [granola, figma, gmail],
    },
    m4: {
      pill: "Drafting the one-page follow-up",
      host: "figma.com",
      path: "/file/acme-workflow-follow-up",
  ...
  "legal-redlines": {
    ...
    m2: {
      ...
      host: "docs.google.com",
      path: "/document/d/acme-customer-question",
      title: "Acme customer question",
      site: "gdoc",
      tabs: [gmail, gdoc],
    },
    m3: {
      pill: "Building the answer package",
      host: "docs.google.com",
      path: "/document/d/acme-customer-question",
      title: "Acme customer question",
      site: "gdoc",
  ...
  "attach-engine": {
    m1: {
      ...
      host: "acme.com",
      path: "/company/technical-update",
      title: "Public technical update",
      site: "research",
