...
const ROWS: { label: string; values: string[] }[] = [
  ...
  },
  {
    label: "What you get",
    values: [
      "Finished work ready for review",
  ...
  return (
    <section id="compare" className="compare">
      ...
      <p className="section-lede">
        A fleet of agents can keep work moving in the cloud, even when the
        seller is in another meeting.
      </p>
